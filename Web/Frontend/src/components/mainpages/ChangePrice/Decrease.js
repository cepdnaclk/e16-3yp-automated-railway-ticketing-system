...
function Decrease() {
    ...
    const handleSubmit = async e =>{
        ...
        try {
            ...
            const res = await axios.put(`/api/payments/decrease`,{...payment},{
    ...
    return (
        <div>
            <form onSubmit={handleSubmit} className="container mt-5 border border-primary rounded p-5">
                <h3 className="col text-center mb-5">Decrease All Prices by</h3> <br/>
                <p className="col text-center mb-5"><strong>Enter the amount you want to decrease for each class</strong></p>
                ...
                <div class="col text-center">
                    <button class="btn btn-success" type="submit">Decrease</button>
                </div>
            </form>
            <Footer />
        </div>
